...
func Test_Distinct(t *testing.T) {
	...
	for name, test := range tests {
		t.Run(name, func(t *testing.T) {
			s := itr8.Distinct(itr8.All(test.values))
...
func Test_Seq_DrainTo(t *testing.T) {
	...
	for name, test := range tests {
		t.Run(name, func(t *testing.T) {
			...
			itr8.All(test.values).DrainTo(&sink)
...
func Test_Seq_Filter(t *testing.T) {
	...
	for name, test := range tests {
		t.Run(name, func(t *testing.T) {
			s := itr8.All(test.values).Filter(test.test)
...
func Test_Seq_FindAny(t *testing.T) {
	...
	for name, test := range tests {
		t.Run(name, func(t *testing.T) {
			res := itr8.All(test.values).FindAny()
...
func Test_FlatMap(t *testing.T) {
	f := func(n int) itr8.Seq[int] {
		return itr8.Of(n)
	}

	tests := map[string]struct {
		values []int
		fn     func(n int) itr8.Seq[int]
	}{
	...
	for name, test := range tests {
		t.Run(name, func(t *testing.T) {
			s := itr8.FlatMap(itr8.All(test.values), test.fn)
...
func Test_Seq_ForEach(t *testing.T) {
	...
	for name, test := range tests {
		...
		t.Run(name, func(t *testing.T) {
			itr8.All(test.values).ForEach(test.fn)
...
func Test_Seq_Limit(t *testing.T) {
	...
	for name, test := range tests {
		t.Run(name, func(t *testing.T) {
			s := itr8.All(test.values).Limit(test.limit)
...
func Test_Map(t *testing.T) {
	...
	for name, test := range tests {
		t.Run(name, func(t *testing.T) {
			s := itr8.Map(itr8.All(test.values), test.fn)
...
func Test_Seq_Peek(t *testing.T) {
	...
	for name, test := range tests {
		t.Run(name, func(t *testing.T) {
			...
			s := itr8.All(test.values).Peek(test.fn)
...
func Test_Reduce(t *testing.T) {
	...
	for name, test := range tests {
		t.Run(name, func(t *testing.T) {
			sum := itr8.Reduce(itr8.All(test.values), 0, sum)
...
func Test_Seq_Skip(t *testing.T) {
	...
	for name, test := range tests {
		t.Run(name, func(t *testing.T) {
			s := itr8.All(test.values).Skip(test.n)
...
func Test_Seq_TakeWhile(t *testing.T) {
	...
	for name, test := range tests {
		t.Run(name, func(t *testing.T) {
			s := itr8.All(test.values).TakeWhile(test.fn)
...
func Test_Seq_TakeUntil(t *testing.T) {
	...
	for name, test := range tests {
		t.Run(name, func(t *testing.T) {
			s := itr8.All(test.values).TakeUntil(test.fn)
...
func Test_Seq_ToSlice(t *testing.T) {
	...
	for name, test := range tests {
		t.Run(name, func(t *testing.T) {
			res := itr8.All(test.values).ToSlice()
		...
		t.Run(name, func(t *testing.T) {
			...
			if panics {
				assert.Panics(t, func() {
					for range itr8.ZipStrict(as, bs) {
					}
				})
			} else {
				s := itr8.ZipStrict(as, bs)
				for a, b := range s {
					resAs = append(resAs, a)
					resBs = append(resBs, b)
				}
...
func countElems[A any](s itr8.Seq[A]) int {
	return len(consumeSeq(s))
}

func consumeSeq[A any](s itr8.Seq[A]) []A {
	res := make([]A, 0)
	for e := range s {
		res = append(res, e)
	}
